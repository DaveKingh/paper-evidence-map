...
1. Replace every `YOUR_USERNAME` and maintainer placeholder.
2. Add a 1280×640 social preview derived from `assets/demo.svg`.
...
5. Ask 3–5 researchers from different fields to test one real paper and report missing evidence.
...
- Publish the repository, release, social preview, and a 60–90 second screen recording.
- Pin one issue: “Share a paper-reading failure case.”
...
- Post concise versions to GitHub, X/LinkedIn, Reddit communities that allow project sharing, Hacker News `Show HN`, and Chinese research/AI communities such as 知乎 or小红书 where appropriate.
...
- Publish a monthly “what the workflow still misses” report.
...
2. Highlight the abstract claim: “8 points on both datasets.”
3. Run `Round 1`.
...
6. End on: “Traceable does not mean true—but untraceable is harder to challenge.”
